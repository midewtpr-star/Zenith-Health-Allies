        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {resources.map((resource, index) => (
              <div key={index} className="bg-card p-8 rounded-2xl shadow-soft border border-border/50">
                ...
                <h3 className="font-serif text-xl text-foreground mb-3">{resource.title}</h3>
